...
class UserServiceImplTest {
    ...
    void getByEmail은_ACTIVE_상태인_유저를_찾아올_수_있다() {
        User result = userServiceImpl.getByEmail("jeongdalma@gmail.com");
    ...
    void getByEmail은_PENDING_상태인_유저를_찾아올_수_없다() {
        ...
        Assertions.assertThatThrownBy(() -> {
            userServiceImpl.getByEmail("jeongdalma2@gmail.com");
    ...
    void 유저를_수정할_수_있다() {
        ...
        User user = userServiceImpl.update(1L, update);
    ...
    void PENDING_상태의_사용자는_잘못된_인증_코드를_받으면_예외를_던진다() {
        Assertions.assertThatThrownBy(() -> {
            userServiceImpl.verifyEmail(2, "aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaab22");
